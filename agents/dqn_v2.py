    ...
    def trainAgent(self, episodes):
        ...
        for episode in range(0, episodes):
            ...
            if episode > 0:
                ...
                file.close()
                # Print to console for cloud SSH
                print(f"Episode: {episode-1} | Reward: {episodeReward:.2f} | Epsilon decay: {self.epsilon:.5f} | Policy Loss: {loss:.5f}")
            ...
            if episode % SAVE_INTERVAL == 0 and episode > 0:
                ...
                filename = f"models/savedPolicyNet{episode}.pth"
        ...
        file = open("log.txt", "a")
        file.write(str((episodes-1, episodeReward, loss, self.epsilon)) + "\n")
        file.close()
        print(f"Episode: {episodes-1} | Reward: {episodeReward:.2f} | Epsilon decay: {self.epsilon:.5f} | Policy Loss: {loss:.5f}")
